...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/tygerbytes/posh-dynargs/blob/v0.1.0.3/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/tygerbytes/posh-dynargs'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/tygerbytes/posh-dynargs/blob/v0.1.0.3/CHANGELOG.md'
    }
