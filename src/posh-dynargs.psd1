...
PrivateData = @{
    ...
    PSData = @{
        ...
        # TODO:
        LicenseUri = 'https://github.com/tygerbytes/posh-dynargs/blob/v0.1.0.0/LICENSE.txt'
        ...
        # TODO
        ReleaseNotes = 'https://github.com/tygerbytes/posh-dynargs/blob/v0.1.0.0/CHANGELOG.md'
    }
